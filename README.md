...
current 64-bit GNU/Linux platform versions, such as Centos 7, Red Hat 8, Debian 8 or later, and Ubuntu 18.04 or later.
...
* The required CentOS 7 & Red Hat 8 package to install is: `gcc-c++`.
...
* The CentOS 7 & Red Hat 8 OpenSSL packages to install are:  `openssl` and
...
by the build environment.  In that case:
	...
	* The CentOS 7 & Red Hat 8 Lua package to install is:  `lua`, and also
...
install the package `python`, while on other distros, such as Red Hat 8,
