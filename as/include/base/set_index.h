...
// Info & stats.
bool as_set_index_enable(struct as_namespace_s* ns, struct as_set_s* p_set,
		uint16_t set_id, as_set_index_mode new_way);
bool as_set_index_disable(struct as_namespace_s* ns, struct as_set_s* p_set,
		uint16_t set_id, as_set_index_mode new_way);
