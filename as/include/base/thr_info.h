...
info_param_result as_info_parameter_get(const char* param_str,
		const char* param, char* value, int* value_len);
info_param_result as_info_param_get_namespace_id(const char* params,
		char* value, int* value_len);
info_param_result as_info_param_get_namespace_ns(const char* params,
		char* value, int* value_len);
info_param_result as_info_param_get_namespace(const char* params, char* value,
		int* value_len);

bool as_info_required_param_is_ok(cf_dyn_buf* db, const char* param,
		const char* value, info_param_result result);
info_param_result as_info_optional_param_is_ok(cf_dyn_buf* db,
		const char* param, const char* value, info_param_result result);
bool info_param_required_local_namespace_is_ok(cf_dyn_buf* db, char* value,
		struct as_namespace_s** ns, info_param_result result);
info_param_result info_param_optional_local_namespace_is_ok(cf_dyn_buf* db,
		char* value, struct as_namespace_s** ns, info_param_result result);
