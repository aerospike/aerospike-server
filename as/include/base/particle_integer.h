...
// Handle "wire" format.
int32_t integer_concat_size_from_wire(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
int integer_append_from_wire(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
int integer_prepend_from_wire(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
int integer_incr_from_wire(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
int32_t integer_size_from_wire(const uint8_t* wire_value, uint32_t value_size);
int integer_from_wire(as_particle_type wire_type, const uint8_t* wire_value,
...
void integer_from_msgpack(const uint8_t* packed, uint32_t packed_size,
		as_particle** pp);
