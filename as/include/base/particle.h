...
// Handle "wire" format.
typedef int32_t (*as_particle_concat_size_from_wire_fn)(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
typedef int (*as_particle_append_from_wire_fn)(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
typedef int (*as_particle_prepend_from_wire_fn)(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
typedef int (*as_particle_incr_from_wire_fn)(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
typedef int32_t (*as_particle_size_from_wire_fn)(const uint8_t* wire_value,
		uint32_t value_size);
typedef int (*as_particle_from_wire_fn)(as_particle_type wire_type,
		const uint8_t* wire_value, uint32_t value_size, as_particle** pp);
...
typedef uint32_t (*as_particle_asval_to_wire_fn)(const as_val* val,
		uint8_t* wire);

// Handle msgpack translation.
typedef uint32_t (*as_particle_size_from_msgpack_fn)(const uint8_t* packed,
		uint32_t packed_size);
typedef void (*as_particle_from_msgpack_fn)(const uint8_t* packed,
		uint32_t packed_size, as_particle** pp);

// Handle on-device "flat" format.
typedef const uint8_t* (*as_particle_skip_flat_fn)(const uint8_t* flat,
		const uint8_t* end);
typedef const uint8_t* (*as_particle_from_flat_fn)(const uint8_t* flat,
		const uint8_t* end, as_particle** pp);
