 ...
 */
as_hlc_timestamp_order as_hlc_send_timestamp_order(as_hlc_timestamp local_ts,
		as_hlc_msg_timestamp* msg_ts);
 ...
 */
as_hlc_timestamp as_hlc_timestamp_subtract_ms(as_hlc_timestamp timestamp, int ms);
